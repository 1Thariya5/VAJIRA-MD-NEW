...
module.exports = {
SESSION_ID: process.env.SESSION_ID ===  'VAJIRA-MD=CVMHBAxZ#mlLXwDJ9KH3w5IcMzaETrjF9fB1UAvebkSoqEp2GWwI' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '0768358007' : process.env.OWNER_NUMBER,   
